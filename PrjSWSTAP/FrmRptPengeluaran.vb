...
Public Class FrmRptPengeluaran
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleButton2.Click
        ...
        If saveFileDialog1.ShowDialog() = DialogResult.OK Then
            ...
            If (myStream IsNot Nothing) Then
                ...
                MsgBox("EXSPORT SUCCESS", MessageBoxIcon.Information, "REPORT PENGELUARAN")
            End If
        End If
    End Sub
    ...
    Private Sub FrmRptPengeluaran_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "REPORT PENGELUARAN"
